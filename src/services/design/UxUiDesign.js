...
const UxUiDesign = () => {
  return (
    <PageContainer>
      ...
      {/* Add the rest of the component sections here */}
    </PageContainer>
  );
};

// About UX/UI Design section
...
const LabIndicators = styled.div`
  position: absolute;
  bottom: 1rem;
  right: 1rem;
  display: flex;
