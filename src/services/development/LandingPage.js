  ...
  return (
    <Container>
      ...
      >
        ...
        >
          Розробляємо ефективні landing page, які конвертують відвідувачів у клієнтів. 
          Сучасний дизайн, швидкість завантаження та оптимізація для пошукових систем.
        </Subtitle>
        ...
        >
          <HeroBenefitItem whileHover={{ scale: 1.02 }}>
            <HeroBenefitIcon><FaChartLine /></HeroBenefitIcon>
            <HeroBenefitContent>
          ...
          <HeroBenefitItem whileHover={{ scale: 1.02 }}>
            <HeroBenefitIcon><FaPencilRuler /></HeroBenefitIcon>
            <HeroBenefitContent>
          ...
          <HeroBenefitItem whileHover={{ scale: 1.02 }}>
            <HeroBenefitIcon><FaBolt /></HeroBenefitIcon>
            <HeroBenefitContent>
      ...
      >
        ...
        <PWAInfoContainer>
          ...
          <PWAInfoContent>
            ...
            >
              Ефективний лендінг — це не просто гарна сторінка, а потужний інструмент продажів, 
              який перетворює відвідувачів у клієнтів та приносить реальний прибуток вашому бізнесу.
            </PWASummary>
          </PWAInfoContent>
        </PWAInfoContainer>
      </PWAInfoSection>
            ...
            {[
              {
                ...
                title: 'Цільова дія',
                description:
                  'Лендінг спрямований на одну конкретну дію: купівлю, реєстрацію чи заявку. Це збільшує конверсію та ефективність сторінки.',
              },
              {
                icon: <FaBolt />,
                number: '02',
                title: 'Швидкість сприйняття',
                description:
                  'Користувач отримує всю потрібну інформацію на одній сторінці, не витрачаючи час на навігацію між розділами.',
              },
              {
                icon: <FaPencilRuler />,
                number: '03',
                ...
                description:
                  'Кожен блок логічно пов\'язаний з наступним, ведучи відвідувача до цільової дії через всю необхідну інформацію.',
              },
              {
                icon: <FaBrain />,
                number: '04',
                title: 'Фокус уваги',
                description:
                  'На відміну від багатосторінкових сайтів, лендінг не розпорошує увагу відвідувача між різними розділами та опціями.',
              },
              {
                icon: <FaTools />,
                number: '05',
                title: 'Легке тестування',
                description:
                  'Простіше аналізувати поведінку користувачів та оптимізувати сторінку для кращої конверсії.',
              },
              {
                icon: <FaRocket />,
                number: '06',
                ...
                description:
                  'Створення та запуск лендінгу займає значно менше часу, ніж розробка повноцінного сайту.',
              },
            ].map((benefit, index) => (
              <PWABenefitCard
                key={index}
      ...
      >
        ...
        <PWAServicesContainer>
          ...
          <PWAServicesContent>
            ...
            <ServicesList>
              {[
                'Індивідуальний підхід до вашого бізнесу — враховуємо специфіку ніші та конкурентні переваги',
                'Дизайн, що чіпляє та запам\'ятовується — створюємо унікальний візуальний стиль',
                'Висока швидкість завантаження й адаптивність — працює ідеально на всіх пристроях',
                'SEO-оптимізація для просування в Google — забезпечуємо видимість у пошуку',
                'Підключення аналітики й готовність до реклами — відстежуємо ефективність',
                'Продумана структура та психологія продажів — ведемо клієнта до цільової дії',
                'Регулярне тестування та оптимізація — покращуємо конверсію'
              ].map((service, index) => (
                <ServiceItem
                  key={index}
                  variants={itemVariants}
            ...
            <PWAServiceSummary>
              Професійний лендінг — це не просто красива сторінка, а потужний маркетинговий інструмент, 
              який працює на досягнення ваших бізнес-цілей 24/7.
            </PWAServiceSummary>
      ...
      >
        ...
        <WhyUsContainer>
            ...
            {[
              {
                ...
                title: 'Сфера послуг',
                description:
                  'Ідеально підходить для юридичних, косметологічних, будівельних та інших послуг, де важливо детально представити переваги та викликати довіру клієнта.',
              },
              {
                icon: <FaBrain />,
                title: 'Онлайн-навчання',
                description:
                  'Ефективний інструмент для продажу онлайн-курсів, тренінгів та інфопродуктів. Дозволяє розкрити цінність навчальної програми.',
              },
              {
                icon: <FaShoppingCart />,
                title: 'Продаж товарів',
                description:
                  'Чудово працює для презентації окремих товарів або нових колекцій, особливо коли потрібно детально показати переваги продукту.',
              },
              {
                icon: <FaRocket />,
                title: 'Стартапи',
                description:
                  'Допомагає швидко вивести новий продукт на ринок, зібрати перших клієнтів та протестувати попит на інноваційні рішення.',
              },
            ].map((item, index) => (
              <WhyUsCard
                key={index}
          ...
          >
            ...
            >
              Фактично, будь-який бізнес, що має конкретну цільову аудиторію та чітку пропозицію, 
              виграє від використання лендінгу.
            </motion.p>
          </WhyUsAction>
        </WhyUsContainer>
        ...
        <CtaContainer>
          ...
          <CtaContent>
            ...
            <CtaText
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              Бажаєте отримати сучасний односторінковий сайт, який буде приносити реальні заявки та продажі? 
              Ми створимо для вас продаючий лендінг з унікальним дизайном та високою конверсією.
            </CtaText>
            ...
            >
              Залиште заявку — і ми зв'яжемося з вами для обговорення вашого проєкту,
              розрахунку вартості та термінів розробки.
            </CtaSubtext>
        ...
        <FaqContainer>
          ...
          >
            {[
              ...
              {
                question: 'Чим односторінковий сайт відрізняється від звичайного сайту?',
                answer:
