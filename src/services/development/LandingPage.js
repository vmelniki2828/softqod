...
const LPEffectivenessGlow = styled.div`
  position: absolute;
  width: 30vw;
  height: 30vw;
  border-radius: 50%;
...
const LPEffectivenessPattern = styled.div`
  position: absolute;
  inset: 0;
...
const LPEffectivenessContainer = styled.div`
  max-width: 1200px;
  margin: 0 auto;
  position: relative;
  z-index: 2;
...
const LPEffectivenessTitle = styled(motion.h2)`
