...
const CorporateWebsitePage = () => {
  return (
    <PageContainer>
      ...
      >
        <MainTitle>Корпоративные сайты</MainTitle>
        <MainSubtitle>
          Современные решения для представления вашей компании в интернете
        </MainSubtitle>
      </MainHero>
        ...
        <PathContainer>
          ...
          <PathSteps>
            ...
            >
              ...
              <StepDescription>
                Изучение требований и проектирование сайта
              </StepDescription>
              <StepFeatures>
                <StepFeature>
            ...
            >
              ...
              <StepFeatures>
                ...
                <StepFeature>
                  <FaCheck /> Верстка и программирование
                </StepFeature>
                <StepFeature>
                  <FaCheck /> Интеграция с CRM
                </StepFeature>
              </StepFeatures>
            </PathStep>
            ...
            >
              ...
              <StepDescription>
                Развертывание и продвижение сайта
              </StepDescription>
              <StepFeatures>
                <StepFeature>
                  <FaCheck /> Размещение на хостинге
                </StepFeature>
                <StepFeature>
                  <FaCheck /> SEO-оптимизация
                </StepFeature>
                <StepFeature>
      ...
      <FeaturesGrid>
        ...
        >
          ...
          <FeatureTitle>Корпоративный стиль</FeatureTitle>
          <FeatureDescription>
            Единый стиль и брендинг компании
          </FeatureDescription>
        </FeatureCard>
        ...
        >
          ...
          <FeatureTitle>О компании</FeatureTitle>
          <FeatureDescription>
        ...
        >
          ...
          <FeatureTitle>Новости и блог</FeatureTitle>
          <FeatureDescription>
      ...
      <SystemsSection>
        ...
        <SystemsGrid>
          <SystemCard
            ...
            whileTap={{ scale: 0.95 }}
          >
            <SystemIcon><FaDesktop /></SystemIcon>
            <SystemTitle>Адаптивный дизайн</SystemTitle>
            <SystemDescription>
          ...
          >
            ...
            <SystemTitle>SEO-оптимизация</SystemTitle>
            <SystemDescription>
          ...
          >
            ...
            <SystemDescription>
              Отслеживание посещаемости и поведения пользователей
            </SystemDescription>
          </SystemCard>
          ...
          <SystemCard
            ...
            whileTap={{ scale: 0.95 }}
          >
            <SystemIcon><FaUserTie /></SystemIcon>
            <SystemTitle>CRM-интеграция</SystemTitle>
            <SystemDescription>
          ...
          >
            ...
            <SystemDescription>
              Защита данных и SSL-сертификат
            </SystemDescription>
          </SystemCard>
          ...
          <SystemCard
            ...
            whileTap={{ scale: 0.95 }}
          >
            <SystemIcon><FaHandshake /></SystemIcon>
            <SystemTitle>Формы обратной связи</SystemTitle>
            <SystemDescription>
              Сбор контактов и обращений
            </SystemDescription>
          </SystemCard>
          ...
          <SystemCard
            ...
            whileTap={{ scale: 0.95 }}
          >
            <SystemIcon><FaGlobeAmericas /></SystemIcon>
            <SystemTitle>Многоязычность</SystemTitle>
            <SystemDescription>
          ...
          <SystemCard
            ...
            whileTap={{ scale: 0.95 }}
          >
            <SystemIcon><FaSitemap /></SystemIcon>
            <SystemTitle>Управление контентом</SystemTitle>
            <SystemDescription>
